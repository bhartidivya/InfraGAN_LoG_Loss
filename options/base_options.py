...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot',default='/media/Data16T/Kishore/EE5179_kaggle/data_aug/', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='thermal', help='chooses how datasets are loaded. [unaligned | aligned | single]')
