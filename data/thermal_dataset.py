...
class ThermalDataset2(BaseDataset):
...
class ThermalDataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        rgb = Image.open(os.path.join(self.base_path, "RGB",self.mode,rgb_imName)).convert("RGB")
        thermal = Image.open(os.path.join(self.base_path, "thermal",self.mode, thermal_imName)).convert("RGB")
#         print(rgb.shape,thermal.shape)
    ...
    def __len__(self):
        print("rgb iamges",len(self.rgb_imgNames))
